...
IMPORT_REPO_TITLE="spp_misc-code"
#echo "What is the import repo's remote location (HTTPS)?:"
IMPORT_REPO_REMOTE_HTTPS="https://github.com/SchponzeePlusPlus/spp_misc-code.git"
#read IMPORT_REPO_REMOTE_HTTPS
IMPORT_REPO_BRANCH="main"
IMPORT_REPO_CONTENT_SUB_DIR="geeksforgeeks"

TARGET_REPO_TITLE="geeksforgeeks"
...
TARGET_REPO_MERGING_BRANCH="feature/LISS-001-imp-misc-code-gfg-000"
TARGET_REPO_IMPORTED_CONTENT_SUB_DIR="prblm"
